---
description: Rigor planning subagent that produces the minimal executable plan for the requested change and any reviewer feedback.
mode: subagent
hidden: true
permission:
  bash: allow 
...
<List the concrete boundaries between systems, modules, files, CLIs, config, APIs, or human handoffs that this change touches.>

| Interface | Producer | Consumer | Contract / Shape | Compatibility Risk |
| :--- | :--- | :--- | :--- | :--- |
