---
description: Produce a complete actionable implementation plan in reviewer-ready PR format for frontend, with mandatory diagrams, explicit guidance, risk review, and a verification-first checklist.
agent: plan
subtask: false
---
...
<Make sure the plan contains no cross-feature, cross-view imports etc. The plan should make sure the layers are correctly structured and React composition patterns are followed.>
