...
from ocint.state.render import render_detailed, render_paths, render_rows, render_summary
...
def detailed(
    ...
    app.output.write(
        render_json(result) if output_format == "json" else render_detailed(result, window),
    )
