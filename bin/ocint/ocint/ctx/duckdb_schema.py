from sqlalchemy import BigInteger, Column, Index, Integer, MetaData, String, Table, Text, UniqueConstraint
...
ctx_event = Table(
    ...
    metadata,
    Column("id", Integer, primary_key=True, autoincrement=False),
    # DuckDB FTS uses this stable string key as the document identifier; public
    # stable views keep exposing only native event IDs.
