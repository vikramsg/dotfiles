...
def test_skill_command_suite_reads_imported_index(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    checks: list[tuple[Sequence[str], str]] = [
        ...
        (["ctx", "search", "native event marker"], "p-primary-step"),
        ...
        (["ctx", "search", "native event marker", "--workspace", "/work/repo-directory-only"], "p-primary-step"),
        (["ctx", "search", "native event marker", "--file", "AGENTS.md"], "p-primary-step"),
        (["ctx", "search", "native event marker", "--since", "30d"], "p-primary-step"),
        (["ctx", "search", "native event marker", "--term", "related term", "--term", "error text"], "p-primary-step"),
        (["ctx", "search", "native event marker", "--session", "s-primary"], "p-primary-step"),
        (["ctx", "search", "native event marker", "--verbose"], "citation:"),
        (["ctx", "search", "subagent only marker", "--include-subagents"], "s-sub"),
        (["ctx", "search", "native event marker", "--include-current-session"], "p-primary-step"),
